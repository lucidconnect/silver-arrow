...
func SetupDatabase(dbconn *sql.DB) (*gorm.DB, error) {
	...
	// ...
	if err = db.AutoMigrate(models.Token{}, models.DepositWallet{}, models.Price{}, models.CheckoutSession{}, models.PaymentLink{}, models.MerchantAccessKey{}, models.Payment{}, models.Wallet{}, models.Merchant{}, models.Key{}, models.Subscription{}, models.Product{}); err != nil {
