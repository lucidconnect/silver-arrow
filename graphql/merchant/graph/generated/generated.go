...
func (ec *executionContext) _Query_fetchMerchantStats(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMerchantStats2ᚖgithubᚗcomᚋhelicarrierstudioᚋsilverᚑarrowᚋgraphqlᚋmerchantᚋgraphᚋmodelᚐMerchantStats(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMerchantStats2githubᚗcomᚋhelicarrierstudioᚋsilverᚑarrowᚋgraphqlᚋmerchantᚋgraphᚋmodelᚐMerchantStats(ctx context.Context, sel ast.SelectionSet, v model.MerchantStats) graphql.Marshaler {
	return ec._MerchantStats(ctx, sel, &v)
}

func (ec *executionContext) marshalNMerchantStats2ᚖgithubᚗcomᚋhelicarrierstudioᚋsilverᚑarrowᚋgraphqlᚋmerchantᚋgraphᚋmodelᚐMerchantStats(ctx context.Context, sel ast.SelectionSet, v *model.MerchantStats) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
